...
| 11  | OTA 固件升级                                         | 3 天    | 一期 ✅（分区表 + flash 交接已于 2026-06 交付）；HTTP 下载 / 校验 / UI 浮层待交付。决定复用 `esp-bootloader-esp-idf::OtaUpdater` 后，总工作量从 5 天压缩到 3 天。详见 [docs/ota-design.zh-CN.md](./docs/ota-design.zh-CN.md)。 |
